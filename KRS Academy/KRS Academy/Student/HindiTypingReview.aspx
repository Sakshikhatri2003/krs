<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HindiTypingReview.aspx.cs" Inherits="KRS_Academy.Student.HindiTypingReview" %>
                ...
                <div class="card bg-info">
                    <div class="card-body">
                        <div style="display: flex; align-items: center;">
                            ...
                            <div>
                                <h2 class="text-center" style="font-weight: 500;">Congratulations
                                    <asp:Label ID="stuName" runat="server"></asp:Label>
                                    You have completed the exam successfully.</h2>
                      ...
                      &nbsp;<asp:Label ID="TimeAllocate" runat="server"></asp:Label>
                                        Mins
                                    </div>
                                    <div class="col option">
                      ...
                      &nbsp;
                                        <asp:Label ID="GrossSpeed" runat="server"></asp:Label>
                                        WPM
                                    </div>
                                    <div class="col option">
                      ...
                      &nbsp;<asp:Label ID="Marks" runat="server"></asp:Label>/<asp:Label ID="TotalMarks" runat="server"></asp:Label>
                                    </div>
                    ...
                    <div class="inner-card">
                        <div class="card-body">
                            <p runat="server" class="card-text">
                                <label>Given by Us: </label>
                                <br />
                                <asp:Label ID="input" Style="color: green" CssClass="hindi-font" runat="server" />
                            </p>
                            <label>Written by you: </label>
                            <p id="LblResult" runat="server" class="card-text hindi-font">
